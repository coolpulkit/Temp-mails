...
def checkMails():
    ...
    if length == 0:
        ...
        print_statusline(f"You received {length} {x}. (Mailbox is refreshed every 5 seconds automatically.)")
...
banner()
userInput1 = input("Do you wanna use custom domain name (Y/N): ").capitalize()
...
try:
    ...
    if userInput1 == 'Y':
        ...
        pyperclip.copy(mail)
        print("\nYour temp email is " + mail + " (Copied to clipboard.)" +"\n")
